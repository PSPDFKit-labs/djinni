...
::testsuite::RecordWithDurationAndDerivings RecordWithDurationAndDerivings::toCpp() {
    return ::testsuite::RecordWithDurationAndDerivings(
        transform<std::chrono::duration<double, std::nano>, Windows::Foundation::TimeSpan<float64, Windows::Foundation::TimeSpan>>()(Dt));
}
...
RecordWithDurationAndDerivings^ RecordWithDurationAndDerivings::fromCpp(const ::testsuite::RecordWithDurationAndDerivings& value) {
    ...
    ret->Dt = transform<std::chrono::duration<double, std::nano>, Windows::Foundation::TimeSpan<float64, Windows::Foundation::TimeSpan>>()(value.dt);
    return ret;
}
